  ...
  return (
    ...
    >
      <div id="skills" className="max-w-7xl w-full text-center py-32">
        <h1 style={{ fontFamily: "var(--font-audiowide), sans-serif" }} className="text-5xl font-bold mb-12 tracking-tighter">My Skills & Tools</h1>

        {/* Languages Section (Now First) */}
        <h2 style={{ fontFamily: "var(--font-audiowide), sans-serif" }} className="text-3xl font-semibold mb-8">Languages</h2>
        ...
        <h2 style={{ fontFamily: "var(--font-audiowide), sans-serif" }} className="text-3xl font-semibold mb-8">Frameworks & Libraries</h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-3 gap-6 mb-16">
        ...
        {/* Tools Section */}
        <h2 style={{ fontFamily: "var(--font-audiowide), sans-serif" }} className="text-3xl font-semibold mb-8">Tools & Platforms</h2>
